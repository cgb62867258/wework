...
abstract class API
{
    ...
    const APPROVAL_DETAIL = '/cgi-bin/oa/getapprovaldetail?access_token=ACCESS_TOKEN';//审批申请详情
    const TEMPLATE_DETAIL = '/cgi-bin/oa/gettemplatedetail?access_token=ACCESS_TOKEN';//某模板详情
    const POST_APPROVAL = '/cgi-bin/oa/applyevent?access_token=ACCESS_TOKEN';//提交审批申请
    const UPLOAD_TEMP_MEDIA = '/cgi-bin/media/upload?access_token=ACCESS_TOKEN&type=image';//上传临时素材
