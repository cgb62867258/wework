...
{
    public $msgtype = "taskcard";
    public $touser = null; // string
    public $title = null; // string
    public $description = null; // string
    public $url = null; // string
    public $task_id = null; // string
    public $btn = null; // array

    public function __construct($touser=null,$title=null, $description=null, $url=null, $task_id=null,$btn=null)
    {
        $this->touser = $touser;
        $this->title = $title;
        $this->description = $description;
    ...
    public function MessageContent2Array(&$arr)
    {
        ...
        $contentArr = array();
        {
            Utils::setIfNotNull($this->title, "touser", $contentArr);
            Utils::setIfNotNull($this->title, "title", $contentArr);
            Utils::setIfNotNull($this->description, "description", $contentArr);
            if (!is_null($this->url)) {
                Utils::setIfNotNull($this->url, "url", $contentArr);
